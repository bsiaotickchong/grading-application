...
import gui.editables.EditableStudentFirstName;
import gui.editables.EditableStudentLastName;
import gui.editables.EditableStudentMiddleInitial;
import gui.buttons.BackButton;
import gui.buttons.CalculateStudentFinalGradeButton;
import gui.buttons.StudentCourseButton;
import gui.students.StudentAssignmentList;
import gui.students.StudentNoteList;
...
public class StudentPage extends Page {
    ...
    public StudentPage(StudentMetaData studentMetaData,
        ...
        super("Student Page", "Student information and grades for courses " + courseMetaData.getName());
