...
CREATE TABLE assignment_weight (
  ...
  assignment_id INT NOT NULL,
  student_type_id INT NOT NULL,
  max_grade FLOAT DEFAULT 100 NOT NULL,
  weight_percent FLOAT DEFAULT 0 NOT NULL,
...
CREATE TABLE grade_bin (
  ...
  course_id INT NOT NULL,
  student_type_id INT NOT NULL,
  a FLOAT         DEFAULT 93 NOT NULL,
  a_minus FLOAT   DEFAULT 90 NOT NULL,
  b_plus FLOAT    DEFAULT 87 NOT NULL,
  b FLOAT         DEFAULT 83 NOT NULL,
  b_minus FLOAT   DEFAULT 80 NOT NULL,
  c_plus FLOAT    DEFAULT 77 NOT NULL,
  c FLOAT         DEFAULT 73 NOT NULL,
  c_minus FLOAT   DEFAULT 70 NOT NULL,
  d_plus FLOAT    DEFAULT 67 NOT NULL,
  d FLOAT         DEFAULT 63 NOT NULL,
  d_minus FLOAT   DEFAULT 60 NOT NULL,
